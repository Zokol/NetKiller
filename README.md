...
Cross-platform internet-connectivity monitor for air-gapped systems. When any connectivity is detected it sounds a continuous audible alarm, logs the event and shuts down the system. The program runs as a persistent background service and never exits on its own.
